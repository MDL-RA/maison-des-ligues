 ...
 */
final class Version20230306145831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, inscription_id INT DEFAULT NULL, email VARCHAR(100) NOT NULL, roles JSON NOT NULL, numlicence INT NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_CFF65260E7927C74 (email), UNIQUE INDEX UNIQ_CFF652605DAC5993 (inscription_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
